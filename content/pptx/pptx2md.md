...
> 
> 여기서 읽기 순서는 python-pptx가 주는 [[Pasted image 20260218030243.png|컬렉션순서]](backmost in z-order and the last shape is topmost)를 그대로 따르고 있다. pptx 문서 작성 시의 순서가 상당히 중요하게 작용할 것 같다.  
> => 렌더링 한 다음 reading-order 모델 이용 고려
> 
