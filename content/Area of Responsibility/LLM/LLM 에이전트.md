...
LLM 초기에는 좋은 문장을 써서 모델을 원하는 방향으로 유도하는 **[[Pasted image 20260713110339.png|프롬프트 엔지니어링]]** 이 크게 주목받았다. 지금도 시스템 프롬프트, 역할, 출력 형식, 예시를 설계하는 일은 중요하다. 다만 에이전트와 외부 데이터가 결합된 환경에서는 프롬프트만으로 충분하지 않다.
